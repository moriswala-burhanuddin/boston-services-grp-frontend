    ...
    <section id="about" className="border-t border-line py-24 md:py-32">
      <div className="container-page grid items-start gap-16 lg:grid-cols-[1fr_1.6fr]">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          {items.map(({ icon: Icon, t, d }, index) => (
            <div key={t} className={`group rounded-[2rem] bg-white p-10 shadow-sm ring-1 ring-black/5 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/10 ${index === 0 ? 'md:col-span-2' : ''}`}>
