            ...
            <div className="bg-white rounded-[2rem] border border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] p-8">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                {lead.photos.map((photo: any) => (
                  <a key={photo.id} href={photo.image} target="_blank" rel="noreferrer" className="block relative aspect-square rounded-2xl overflow-hidden border border-gray-100 hover:border-[#ff6b00] transition-colors group shadow-sm hover:shadow-md bg-gray-50">
                    <img src={photo.image} alt="Lead upload" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
                  </a>
                ))}
              </div>
            </div>
